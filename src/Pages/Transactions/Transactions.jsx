...
const Transactions = () => {
    ...
    const url = "https://sa-p-newbrokerbackend.onrender.com/api/alldeposit"
    const url2 = "https://sa-p-newbrokerbackend.onrender.com/api/allwithdrawal"
    const url3 = `https://sa-p-newbrokerbackend.onrender.com/api/getalltransactions/${id}`
